...
public:
	...
	void SetLeft(const tree_node_ptr &pLeft) { _pLeft = pLeft; }
	tree_node_ptr GetLeft() const { return _pLeft; }
	void SetRight(const tree_node_ptr &pRight) { _pRight = pRight; }
...
private:
	...
	static int SubTreeSum(const TreeNode::tree_node_ptr &subTreeRoot);
	static void AddLeftSubTree(promise<int> &&prms, const TreeNode::tree_node_ptr &subTreeRoot);
	static void AddRightSubTree(promise<int> &&prms, const TreeNode::tree_node_ptr &subTreeRoot);
